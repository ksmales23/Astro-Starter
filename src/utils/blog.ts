...
const load = async function (): Promise<Array<Post>> {
  ...
  return (
    (await Promise.all(normalizedPosts))
      .sort((a, b) => b.publishDate.valueOf() - a.publishDate.valueOf())
      // Drafts (frontmatter `draft: true`) are visible in `astro dev` for
      // previewing, but always excluded from production builds (incl. RSS).
